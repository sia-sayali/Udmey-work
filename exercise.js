...
let highlightedPargaragh = document.querySelector('.highlighted-pargaragh');

console.dir(highlightedPargaragh);

// 5. BONUS TASK: Try changing the text content of the <p> element
//    you selected in (4) and set it to any other text of your choice

highlightedPargaragh.textContent = 'This was changed by Sayali!'